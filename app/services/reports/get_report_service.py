...
class GetReportService:
    ...
    def get_today_schedules_done(self, user_id: uuid.UUID, tz):
    ...
    def get_today_schedules_undone(self, user_id: uuid.UUID, tz):
        start, end = self._get_today_range(tz)
        schedules = [schedule for schedule in self.schedule_service.schedule_dao.get_user_schedules(user_id)
    ...
    def get_tomorrow_schedules(self, user_id: uuid.UUID, tz):

...
class ScheduleService:
    ...
    def get_schedule_by_date_range_status(self, user_id: UUID, start, end,
    ...
    def get_schedule_count_by_date_range(self, user_id: UUID, start, end,
                                status: Optional[str] = None) -> int:
        return self.schedule_dao.get_count_by_date_range(
            user_id, start, end, status=status
        )
    
    def get_schedule_by_ongoing(self, user_id: UUID, current_time: timezone) -> List[Dict]:

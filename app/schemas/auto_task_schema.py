...
def register_models(ns):
    ...
    auto_task_model = ns.model('AutoTask', {
        ...
        'tool': api_fields.Raw(required=False, description='사용 도구 (JSON 객체/배열)'),
        'linked_service': api_fields.Raw(required=False, description='연동된 서비스 (JSON 객체/배열)'),
        'current_step': api_fields.Raw(required=False, description='현재 실행 중인 단계 (JSON 객체/값)'),
    ...
    auto_task_response = ns.model('AutoTaskResponse', {
        'id': api_fields.String(readonly=True, description='AutoTask UUID'),
        'user_id': api_fields.String(required=True, description='User UUID'),
        'title': api_fields.String(required=True, description='업무 제목'),
        'description': api_fields.String(required=False, description='업무 설명 (상세 설명)'),
    ...
    return auto_task_model, create_auto_task_model, auto_task_response